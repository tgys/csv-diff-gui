...
QT_MOC_LITERAL(1, 8, 12), // "newOkColumns"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 17), // "onBoxOneActivated"
QT_MOC_LITERAL(4, 40, 4), // "text"
QT_MOC_LITERAL(5, 45, 17), // "onBoxTwoActivated"
QT_MOC_LITERAL(6, 63, 17), // "onNewColumnUpdate"
QT_MOC_LITERAL(7, 81, 14) // "onNewOkPressed"

    },
    "Dialog2\0newOkColumns\0\0onBoxOneActivated\0"
    "text\0onBoxTwoActivated\0onNewColumnUpdate\0"
    "onNewOkPressed"
};
...
void Dialog2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newOkColumns(); break;
        case 1: _t->onBoxOneActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->onBoxTwoActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->onNewColumnUpdate(); break;
        case 4: _t->onNewOkPressed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Dialog2::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog2::newOkColumns)) {
                *result = 0;
                return;
            }
        }
